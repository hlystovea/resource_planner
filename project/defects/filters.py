...
class DefectFilter(FilterSet):
    ...
    facility = NumberFilter(field_name='component', lookup_expr='cabinet__hardware__connection__facility')  # noqa(E501)
    connection = NumberFilter(field_name='component', lookup_expr='cabinet__hardware__connection')  # noqa(E501)
